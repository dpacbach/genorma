...
# ===============================================================
# Now invoke any user-defined project files -- this means any
# .mk files in the top-level folder of the project.  If there are
# none then just assume a basic minimal project.
# ===============================================================
OLD_CWD := $(CWD)
CWD     := $(root)
...
ifneq ($(project_files),)
    ...
    # Basic minimal project with environment defaults.  Creates
